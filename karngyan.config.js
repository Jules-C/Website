...
export default {
  name: "Julie Cook",
  domain: "gingerpenguin.dev", // add without https:// , used in meta tags and share urls
  image: "/images/pingo.png",
  email: "juliecook328@gmail.com",
  googleAnalyticsV4: {
    enabled: false,
    id: "",
  },
  ...
  social: {
    github: "Jules-C",
    linkedin: "juliecook328",
    // facebook: 'karnsometimes',
    // twitter: 'gyankarn',
    // instagram: 'karngyan.dev',
    codestats: "jules-c", // https://codestats.net make a profile if you dont already have one.
  },
  buyMeACoffee: {
    enabled: false,
  ...
  resume: {
    enabled: true,
    pdfUrl: "/JCook_DarkCV.pdf", // add files in static folder
  },
  uses: {
    enabled: true,
    meta: [
      { title: "OS", value: "macOS Ventura" },
      { title: "Memory", value: "16 GB 2133 MHz LPDDR3" },
      ...
      {
        title: "Laptop • Processor",
        value: "MacBook Pro (13-inch, 2017) • 2.5 GHz Dual-Core Intel Core i7",
      },
    ],
  },
  workedAt: {
  ...
  strings: {
    en_US: {
      ...
      blog: {
        header: "blog",
        subtext:
          "i try to write once in a while. let me know your thoughts in comments or mail@gingerpenguin.dev",
      },
      recentBlog: {
        header: "recent blogs",
